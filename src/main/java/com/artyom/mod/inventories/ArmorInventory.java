...
public class ArmorInventory implements Inventory {
    ...
    public ArmorInventory(int width, int height, ItemStack container) {
        this.width = width;
        this.height = height;
   ...
   public void write() {
       if (this.container != null && !this.container.isEmpty()) {
           this.container.getOrCreateNbt().put("ArmorContent", Inventories.writeNbt(new NbtCompound(), this.list, true));
       }
   }

   public void read() {
       if (this.container != null && !this.container.isEmpty()) {
           Inventories.readNbt(this.container.getOrCreateNbt().getCompound("ArmorContent"), this.list);
       }
   }
